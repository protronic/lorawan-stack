...
// Apply applies the client configuration options to the given TLS configuration.
// If tlsConfig is nil, this is a no-op.
func (c *Client) Apply(tlsConfig *tls.Config) error {
	if tlsConfig == nil {
		return nil
	}
	if c.RootCA != "" {
...
// Apply applies the TLS authentication configuration options to the given TLS configuration.
// If tlsConfig is nil, this is a no-op.
func (c *ServerAuth) Apply(tlsConfig *tls.Config) error {
	if tlsConfig == nil {
		return nil
	}
	switch c.Source {
...
// Apply applies the TLS authentication configuration options to the given TLS configuration.
// If tlsConfig is nil, this is a no-op.
func (c *ClientAuth) Apply(tlsConfig *tls.Config) error {
	if tlsConfig == nil {
		return nil
	}
	switch c.Source {
