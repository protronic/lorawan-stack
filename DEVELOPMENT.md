...
|-- support                     Cypress commands (4)
|-- screenshots                 screenshots generated when running tests (5)
`-- videos                      videos generated when running tests (6)
```
...
- Tests are grouped by views for a specific entity. For example, when testing creation of application API keys:
  1. Add test file `cypress/integration/console/applications/api-keys/create.js`.
...
When writing smoke tests we comply with he following guidelines:

- Smoke tests are testing complete user behavior to perform some complex flow. For example, when testing registration of The Things uno:
